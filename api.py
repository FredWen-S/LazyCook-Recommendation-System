...
class RecRequest(BaseModel):
    fridge: List[str] = Field(..., description="冰箱里的食材列表")
    k: int = Field(5, ge=1, le=20, description="返回前K条")
    time_limit: Optional[int] = Field(None, ge=1, le=120, description="最多用时（分钟）")
